...
export default function ClientsPage() {
  ...
  const fetchClients = async () => {
    setLoading(true);
    console.log('[v0] Fetching clients from Supabase...');
    ...
    if (error) {
      ...
      console.log('[v0] Clients fetched successfully, count:', data?.length || 0);
      setClients(data || []);
    }
      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="border border-gray-300 text-gray-700 px-4 py-2 rounded-lg flex gap-2 hover:bg-gray-50"
          >
