  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage roles and platform users</p>
      </div>

      <Tabs value={activePanel} onValueChange={setActivePanel}>
        <TabsList className="bg-muted">
          <TabsTrigger value="roles" className="text-xs">User Roles</TabsTrigger>
          <TabsTrigger value="users" className="text-xs">Add / Manage Users</TabsTrigger>
        </TabsList>
